# -*- coding: utf-8 -*-
#
# Caliopen user API documentation build configuration file, created by
# sphinx-quickstart on Sun Jul 12 14:25:29 2015.
#
...
settings = get_appsettings(os.path.join(here, '..',
...
htmlhelp_basename = 'CaliopenuserAPIdoc'
...
latex_documents = [
  (master_doc, 'CaliopenuserAPI.tex', u'Caliopen user API Documentation',
   u'contact@caliopen.org', 'manual'),
]
...
man_pages = [
    (master_doc, 'caliopenuserapi', u'Caliopen user API Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'CaliopenuserAPI', u'Caliopen user API Documentation',
   author, 'CaliopenuserAPI', 'One line description of project.',
   'Miscellaneous'),
]
